...
@class SZKLineGroupModel;

typedef NS_ENUM(NSInteger, SZKLineCoinType) {
    SZKLineCoinTypeBTC = 1,   //比特币
    SZKLineCoinTypeETH,       //以太坊
    SZKLineCoinTypeNone       //未定义类型
};
 ...
 *  货币类型
 */
@property (nonatomic, assign) SZKLineCoinType CoinType;

/**
 *  前一个Model
 */
@property (nonatomic, strong) SZKLineModel *PreviousKlineModel;

/**
 *  父ModelArray:用来给当前Model索引到Parent数组
 */
@property (nonatomic, strong) SZKLineGroupModel *ParentGroupModel;
