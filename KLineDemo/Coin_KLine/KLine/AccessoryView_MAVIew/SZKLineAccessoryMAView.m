...
@interface SZKLineAccessoryMAView()
...
@implementation SZKLineAccessoryMAView
- (instancetype)init
{
    self = [super init];
    if (self) {
...
+(instancetype)view
{
    SZKLineAccessoryMAView *MAView = [[SZKLineAccessoryMAView alloc]init];
